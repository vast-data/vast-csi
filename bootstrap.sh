...
yum -y install net-tools time nfstest which clang lldb scons libunwind-devel libconfig-devel install doxygen xorg-x11-xauth vim-enhanced zsh dstat centos-release-scl libaio-devel python34 gtest-devel libuuid-devel zlib-devel nc
