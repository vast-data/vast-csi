...
from e2e.builders.helm.base import HelmValuesBuilder, secret_fields
...
class VastBlockHelmValuesBuilder(HelmValuesBuilder):
    ...
    def with_storage_classes(self, system, *, namespace: str = CSI_NAMESPACE) -> Self:
        ...
        self._add_block_sc_group(storage_classes, 0, system, namespace)
        self._add_block_sc_group(storage_classes, 1, system, namespace)
        return self
