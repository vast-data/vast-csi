...
AddCppTest(target='dist/tests/vmsg_ping', source=[build_dir + '/tests/test_vmsg_ping.cpp'])
...
AddCppTest(target='dist/tests/env_config', source=[build_dir + '/tests/test_env_config.cpp'])
