...
usage() {
    ...
    echo "  PROJECT_ID          - The certification component ID from connect.redhat.com/component/view/{id}/images (5f7595a16fd1fbdbe36c0b50 for CSI Driver and 66e6d0dd49f52e86c9d56b1c for Operator)"
