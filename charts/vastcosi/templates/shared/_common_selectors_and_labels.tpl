...
{{- $images := .Values.image -}}
{{- printf "%s:%s"
    (required "image.vastExtensionController.repository is required" (tpl ($images.vastExtensionController.repository | default "") .))
    (required "image.vastExtensionController.tag is required" (tpl ($images.vastExtensionController.tag | default "") .))
-}}
{{- end -}}
