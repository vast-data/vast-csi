...
krb5-libs \
libcap libgcrypt libsolv libxml2 \
...
python3.12 python3.12-devel python3.12-libs \
libnghttp2
...
RUN curl -sSL https://install.python-poetry.org | python3.12 - --version 1.8.5 \
    ...
    && /root/.venv/bin/python -m pip install --upgrade 'setuptools>=83.0.0' jaraco.context wheel \
