...
void MetricsAgentServerImpl::get_generations(Agent::GetGenerationsParams *args, uint16_t request_len,
...
void MetricsAgentServerImpl::get_modified(Agent::GetModifiedParams *args, uint16_t request_len,
